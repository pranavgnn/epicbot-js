...
exports.run = async (bot, message, args) => {
    ...
    if (type === `suggestion`) {
        ...
        declineEmbed.setDescription(`Suggestion #${tag} has been accepted`)
        ...
        message.channel.send(`Suggestion with the tag #${tag} has been successfully accepted by ${message.author}.`)
